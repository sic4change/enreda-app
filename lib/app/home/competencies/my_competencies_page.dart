              ...
              child: StreamBuilder<List<UserEnreda>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    snapshot.data != null && snapshot.data!.isNotEmpty
                        ? snapshot.data!.first
                        : null;
                    final List<Competency> competencies = LocationCache.instance.competencies;
                    return competencies.isNotEmpty
                        ? CompetenciesItemBuilder<Competency>(
                      user: user,
                      snapshot: AsyncSnapshot<List<Competency>>.withData(ConnectionState.done, competencies),
