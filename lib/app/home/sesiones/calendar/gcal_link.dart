...
///
/// Ported from `enredaEntidadSocial`. When opened, Google Calendar shows its
/// event-creation form pre-filled with title, dates, description and location;
/// the user taps Save and the event lands on THEIR OWN calendar — no OAuth, no
/// backend involvement. Works on web (new tab) and mobile (browser/gCal app)
/// via `url_launcher`.
