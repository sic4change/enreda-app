...
class _ControlPanelMobileInterventionPageState extends State<ControlPanelMobileInterventionPage> {
  @override
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            CustomTextBoldTitle(title: StringConst.CONTROL_PANEL, color: AppColors.turquoiseBlue,),
            InkWell(
              onTap: () {
                setState(() {
              ...
              child: Container(
                ...
                child: Row(
                    children: [
                      ...
                      Spacer(),
                      Image.asset(ImagePath.MY_CV, height: 70),
                    ]
                ),
              ),
            ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                SpaceH4(),
                                Image.asset(ImagePath.MY_COMPETENCIES, height: 70),
                              ]
                          ),
                        ),
                      )),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            shape: BoxShape.rectangle,
                            border: Border.all(color: AppColors.primary020.withOpacity(0.3), width: 1),
                            borderRadius: BorderRadius.circular(8.0),
                          ),
                          child: Column(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              ...
                              children: [
                                ...
                                SpaceH4(),
                                Image.asset(ImagePath.MY_DOCUMENTS, height: 70),
                              ]
                          ),
                        ),
                      )),
