        ...
        return StreamBuilder<List<Competency>>(
          ...
          builder: (context, sc) {
            ...
            if (widget.mini) {
              ...
              return user!.cv_state == 'draft' || user!.cv_state == 'blank'
                  ? CvWizard(user: user!)
                  : _myCurriculumWeb(context, user, _photo,
                      competenciesNames); // sin key dinámica
            ...
            if (user!.educationId!.isNotEmpty) {
              ...
              return StreamBuilder(
                  ...
                  builder: (context, snapshotExperiences) {
                    if (snapshotEducations.hasData &&
                        snapshotExperiences.hasData) {
                      final myEducationalExperiencies = snapshotExperiences
                          .data!
                          .where((experience) => experience.type == 'Formativa')
                          .toList();
                      if (myEducationalExperiencies.isNotEmpty) {
                        final areEduactions = myEducationalExperiencies.any(
                            (exp) =>
                                exp.education != null &&
                                exp.education!.isNotEmpty);
                        if (areEduactions) {
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData &&
                ...
                myEducation = snapshot.data!
                    ...
                    .toList();
                myCustomEducation =
                    myEducation!.map((element) => element).toList();
                mySelectedEducation =
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData &&
                ...
                mySecondaryCustomEducation =
                    mySecondaryEducation!.map((element) => element).toList();
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData &&
                ...
                myExperiences = snapshot.data!
                    ...
                    .toList();
                myCustomExperiences =
                    myExperiences!.map((element) => element).toList();
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData &&
                ...
                myPersonalCustomExperiences =
                    myPersonalExperiences!.map((element) => element).toList();
                myPersonalSelectedExperiences =
